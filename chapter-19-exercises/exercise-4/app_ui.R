...
ui <- navbarPage(
  ...
  tabPanel(
    ...
    # text.
    p("This diagram shows how income growth for different income percentile groups have changed
      from 1980 to 2014. It is important to note that this is income", em("growth"), "and not
      just raw income. Studying the metric of income growth illustrates how the income gap
      between the rich (higher percentiles) and the poor (lower percentiles) is continuing to",
      strong("grow"), "rather than", strong("shrink."))
